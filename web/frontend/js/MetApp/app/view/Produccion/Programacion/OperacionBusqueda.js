Ext.define('MetApp.view.Produccion.Programacion.OperacionBusqueda', {
	extend: 'Ext.window.Window',
	height: 400,
	width: 900,
	modal: true,
	autoShow: true,
	alias: 'widget.operacionBusqueda',
	itemId: 'operacionBusqueda',
			...
			items:[
				{
					xtype: 'grid',
					layout: 'fit',
					store: 'Produccion.Programacion.OperacionesStore',
					idProperty: 'id',
					loadMask: true,   
				    listeners: {
					...
					columns: [
						...
						{text: 'Operacion', dataIndex: 'descripcion', flex: 1},			
					],	
				},								
			],			
		});		
