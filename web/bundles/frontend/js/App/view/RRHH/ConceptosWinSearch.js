Ext.define('MetApp.view.RRHH.ConceptosWinSearch', {
	extend: 'Ext.window.Window',
	height: 400,
	width: 900,
	modal: true,
	autoShow: true,
	alias: 'widget.conceptosWinSearch',
	itemId: 'conceptosWinSearch',
			...
			items:[
				{
				    ...
				    listeners: {
				    	cellkeydown: function(cell, td, cellIndex, record, tr, rowIndex, e, eOpts ){
					    	if(e.button == 12){
								var button = Ext.ComponentQuery.query('#insertConcepto')[0];
					...
					},					
					{
						xtype: 'button',
						text: 'Aceptar',
						action: 'actInsertConcepto',
						itemId: 'insertConcepto'
					}		
					],
					columns: [
